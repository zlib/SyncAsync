...
class SwiftTypeParserTests: XCTestCase {
    ...
    func testEscapingClosureWithNamedParams() {
        ...
        let params = [SwiftParam(body: "result: Int", name: "result", type: SwiftType(body: "Int", isCustom: false, genericType: nil)),
                      SwiftParam(body: "error: Error?", name: "error", type: SwiftType(body: "Error?", isCustom: false, genericType: nil))]
    ...
    func testNonEscapingClosureWithTwoEscapingClosures() {
        ...
        XCTAssertEqual(result.isCustom, false)
        let params = [SwiftParam(body: "result: Int", name: "result", type: SwiftType(body: "Int", isCustom: false, genericType: nil)),
                      SwiftParam(body: "success: @escaping Success", name: "success", type: SwiftClosure(body: "@escaping Success", isCustom: true, params: [SwiftParam](), returnType: SwiftType.Void(), attributes: ["@escaping"], isEscaping: true) ),
                      SwiftParam(body: "error: @escaping ErrorBlock", name: "error", type: SwiftClosure(body: "@escaping ErrorBlock", isCustom: true, params: [SwiftParam](), returnType: SwiftType.Void(), attributes: ["@escaping"], isEscaping: true) )]
        XCTAssertEqual(result.params, params)
    }
